...
navbar.innerHTML = `
        <nav class="fixed top-0 left-0 z-40 w-full bg-[#1F4B44]">
            <div class="max-w-7xl mx-auto flex justify-between items-center w-full md:p-5 p-3 md:h-28 h-24">
                ...
                <div data-aos="fade-left" class="items-center flex md:gap-10 gap-5">
                    <ul  class="flex md:flex-row flex-col text-[#fff] items-center md:gap-10">
                        <li><a href="#Überuns"
                                class="hover:text-[#d4e2dd] md:block hidden tracking-wide text-lg transition-all duration-500">Über uns
                            </a>
                        </li>
                        <li><a href="#UnsereDienstleistungen"
                                class="hover:text-[#d4e2dd] md:block hidden tracking-wide text-lg transition-all duration-500">Service
                            </a>
                        </li>
                        <li><a href="#Kontaktieren"
                                class="hover:text-[#d4e2dd] md:block hidden tracking-wide text-lg transition-all duration-500">Kontakt
                            </a>
                        </li>
                        <li><a href="mailto:hello@nestcare.ch"
                                class="hover:text-[#d4e2dd] flex md:text-[16px] text-sm items-center gap-2 tracking-wide text-lg transition-all duration-500"><i
                    ...
                    <i id="mobileMenuBtn"
                    class="fa-solid text-[#d4e2de] fa-bars md:!hidden text-2xl cursor-pointer mr-2"></i>
                </div>
            </div>
        </nav>
